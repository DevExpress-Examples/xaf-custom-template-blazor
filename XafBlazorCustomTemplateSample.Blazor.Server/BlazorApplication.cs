...
using XafBlazorCustomTemplateSample.Blazor.Server.Templates;
...
namespace XafBlazorCustomTemplateSample.Blazor.Server {
    public partial class XafBlazorCustomTemplateSampleBlazorApplication : BlazorApplication {
        ...
        public XafBlazorCustomTemplateSampleBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafBlazorCustomTemplateSampleBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
